...
extern "C" {
	...
	WIEGANDOUT_API void init_wiegandout_controller(WIEGAND_OUT_ID id, int bitcnt, WIEGAND_LOOPBACK_DIRECTION dir, WIEGAND_OUT_BIT_ORDER order);
	...
	WIEGANDOUT_API void wiegandout_controller_enable(WIEGAND_OUT_ID id);
