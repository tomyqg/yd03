...
void avcodec_register_all(void)
{
    ...
    //REGISTER_ENCDEC  (FLV, flv); //[Evan]
    //REGISTER_DECODER (FLV, flv); // [David]
    ...
    //REGISTER_DECODER (H263I, h263i); //[Evan]
    //REGISTER_ENCODER (H263P, h263p);
#if defined(CFG_VIDEO_ENABLE)
    #if defined(CFG_FFMPEG_H264_SW)
    REGISTER_DECODER   (H264, h264);
    #else /* CFG_FFMPEG_H264_SW */
    REGISTER_DECODER   (ITE_H264_DTV, iTE_h264_Dtv); // h/w decoder
...
#if CONFIG_ITE_MJPEG_DECODER
    REGISTER_DECODER   (ITE_MJPEG, ite_mjpeg);
#endif
#if CONFIG_ITE_MJPEG_ENCODER
    REGISTER_ENCODER   (ITE_MJPEG, ite_mjpeg);
#endif
#if CONFIG_MJPEG_ENCODER
    REGISTER_ENCDEC    (MJPEG, mjpeg);
#endif
#if CONFIG_MJPEG_DECODER
    REGISTER_DECODER   (MJPEG, mjpeg);  // only mjpeg decoder
#endif
...
#endif
    //REGISTER_DECODER (MPEG4, mpeg4); // [David]
    ...
    REGISTER_PARSER    (H264, h264);   // [2012/11/23, Evan] h.264 parser
#endif
