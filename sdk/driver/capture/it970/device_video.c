...
////////////////////////////////////////////////////////////////////////////
    ...
    case MMP_CAP_DEV_ADV7180:
        if (1)     //(mmpADV7180IsSignalStable()) //mark benson
        {
    #ifdef HDMI_DEV
...
#ifdef COMPOSITE_DEV
    //mmpADV7180OutputPinTriState(MMP_TRUE); //mark benson
#endif
}
    ...
    void)
{
    ...
    if (gtDeviceReboot)
    {
        ...
        //else
        //mmpADV7180Initialize(); //mark benson
        //mmpADV7180OutputPinTriState(MMP_TRUE); //mark benson
#endif
...
#ifdef COMPOSITE_DEV
        case MMP_CAP_DEV_ADV7180:
            //mmpADV7180OutputPinTriState(MMP_FALSE); //mark benson
            break;
#endif
    ...
    CAP_DEVICE *ptDev)
{
    ...
    mmpCapOnflyResetAllEngine(ptDev);
...
#ifdef COMPOSITE_DEV
        //mmpADV7180Terminate();  //mark benson
#endif
...
#ifdef COMPOSITE_DEV
    case MMP_CAP_DEV_ADV7180:
        isSignalChange = 1;     //mmpADV7180IsSignalStable(); //mark benson
        break;
#endif
...
void
mmpCapGetDeviceInfo(
    CAP_DEVICE *ptDev, MMP_CAP_SHARE *data)
{
    ...
    if (INPUT_DEVICE == MMP_CAP_DEV_ADV7180)
    {
        ...
        rate                = data->FrameRate = ADV7180_TABLE[0].Rate;
        #else
    ...
    data->OutAddrY[0]       = CapMemBuffer[Capctxt->Cap_ID][CAP_MEM_Y0];
    data->OutAddrUV[0]      = CapMemBuffer[Capctxt->Cap_ID][CAP_MEM_UV0];
    data->OutAddrY[1]       = CapMemBuffer[Capctxt->Cap_ID][CAP_MEM_Y1];
    data->OutAddrUV[1]      = CapMemBuffer[Capctxt->Cap_ID][CAP_MEM_UV1];
    data->OutAddrY[2]       = CapMemBuffer[Capctxt->Cap_ID][CAP_MEM_Y2];
    data->OutAddrUV[2]      = CapMemBuffer[Capctxt->Cap_ID][CAP_MEM_UV2];
