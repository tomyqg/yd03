    ...
    SPI_PORT port)
{
    ...
    {
        //SPI_0
        //{SPI_0, 20, 3 }, {SPI_0, 82, 1 },{SPI_0, 23, 3 },
    ...
    static PORT_IO_MAPMING_ENTRY    tSpiChipSelMappingTable[] =
    {
        ...
        //SPI_1
        {SPI_1, 22, 3 }, {SPI_1, 33, 3 }, {SPI_1, 37, 3 }, {SPI_0, 48, 4 }
    };
    ...
    uint32_t    dataSize)
{
    ...
    ithDmaSetRequest(DmaSpiChannel, ITH_DMA_NORMAL_MODE, ITH_DMA_MEM, ITH_DMA_HW_HANDSHAKE_MODE, (port == SPI_0) ? ITH_DMA_SPI0_RX : ITH_DMA_SPI1_RX);
