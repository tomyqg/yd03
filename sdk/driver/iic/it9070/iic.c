    ...
    uint32_t    delay)
{
    ...
    if (IicReferenceCount == 1)
    {
        ...
        ithWriteRegMaskA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, (0 << ITH_GPIO_IIC_MODE_POS), ITH_GPIO_IIC_MODE_MSK);
#else
        ithWriteRegMaskA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, (1 << ITH_GPIO_IIC_MODE_POS), ITH_GPIO_IIC_MODE_MSK);
#endif

#if (defined CFG_IIC0_GPIO_CONFIG_1)
        ithWriteRegMaskA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, (4 << ITH_GPIO_HOST_SEL_POS), ITH_GPIO_HOST_SEL_MSK);
        ithGpioSetMode(ITH_GPIO_PIN2, ITH_GPIO_MODE3);
        ithGpioSetMode(ITH_GPIO_PIN3, ITH_GPIO_MODE3);
#elif (defined CFG_IIC0_GPIO_CONFIG_2)
