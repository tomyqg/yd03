...
void
ithCap_Set_Engine_Reset(void)
{
    ithPrintf("Cap_Engine_Reset\n");
...
{
    ithPrintf("Cap_Engine_Register_Reset\n");
    ...
    CAPTURE_DEV_ID DEV_ID)
{
    ...
    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_CLOCK_SETTING_REGISTER),        0x0,    CAP_MSK_UCLKSRC);
}
    ...
    CAPTURE_DEV_ID DEV_ID, MMP_BOOL flag)
{
    ...
    if (flag == true && (value & 0x08) == 0x00)
        ithWriteRegMaskA(_GetAddress(DEV_ID, CAP_CLOCK_SETTING_REGISTER), 0x08, 0x08);
    else if (flag == false && (value & 0x08) == 0x08)
        ithWriteRegMaskA(_GetAddress(DEV_ID, CAP_CLOCK_SETTING_REGISTER), 0x00, 0x08);
}
    ...
    CAPTURE_DEV_ID DEV_ID, CAP_OUTPUT_INFO *pOutInfo)
{
    ...
    /* Set YUV pitch */
    data    = (((MMP_UINT32)(pOutInfo->OutWidth) >> 3 & 0x3FF) << 3);
    data    |= (((MMP_UINT32)(pOutInfo->OutWidth) >> 3 & 0x3FF) << 19);
    ithWriteRegA(_GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER21), data);
    /*Set scale Width*/
...
{
    //970 don`t need this, just choise the interrup mode that will enable it.
}

void
ithCap_Set_Interrupt_Mode(CAPTURE_DEV_ID DEV_ID, MMP_UINT16 Intr_Mode, MMP_BOOL flag)
{
...
void
ithCap_Set_Interleave(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 Interleave)
{
    MMP_RESULT  result = MMP_SUCCESS;
    MMP_UINT32  data;
...
void
ithCap_Set_Width_Height(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 width, MMP_UINT32 height)
{
    MMP_RESULT  result  = MMP_SUCCESS;
    MMP_UINT32  data    = 0;
...
void
ithCap_Set_ROI_Width_Height(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 width, MMP_UINT32 height)
{
    /* The width & height size of ROI image */
    MMP_UINT32 data = 0;
...
void
ithCap_Set_Clean_Intr(CAPTURE_DEV_ID DEV_ID)
{
...
void
ithCap_Set_Enable_Reg(CAPTURE_DEV_ID DEV_ID, CAP_ENFUN_INFO *pFunEn)
{
...
MMP_RESULT
ithCap_Set_ISP_HandShaking(CAPTURE_DEV_ID DEV_ID, CAP_ISP_HANDSHAKING_MODE mode, CAP_OUTPUT_INFO *pOutInfo)
{
    MMP_RESULT  result;
    MMP_UINT32  data        = 0;
...
MMP_RESULT
ithCap_Set_Error_Handleing(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 errDetectEn)
{
    MMP_RESULT result = MMP_SUCCESS;
...
{
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER11),    dst_Yaddr);
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER12),    dst_UVaddr);
}

void
ithCap_Set_FrameBase_1_Reg(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 dst_Yaddr, MMP_UINT32 dst_UVaddr)
{
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER13),    dst_Yaddr);
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER14),    dst_UVaddr);
}

void
ithCap_Set_FrameBase_2_Reg(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 dst_Yaddr, MMP_UINT32 dst_UVaddr)
{
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER15),    dst_Yaddr);
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER16),    dst_UVaddr);
}

void
ithCap_Set_FrameBase_3_Reg(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 dst_Yaddr, MMP_UINT32 dst_UVaddr)
{
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER17),    dst_Yaddr);
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER18),    dst_UVaddr);
}

void
ithCap_Set_FrameBase_4_Reg(CAPTURE_DEV_ID DEV_ID, MMP_UINT32 dst_Yaddr, MMP_UINT32 dst_UVaddr)
{
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER19),    dst_Yaddr);
    ithWriteRegA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER20),    dst_UVaddr);
}
...
{
    //970 seems like no use this.
}

void
ithCap_Set_16bit_mode(CAPTURE_DEV_ID DEV_ID)
{
    // cap general init for upstream device
    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER2),     1 << 6,     3 << 6);        //input width: 16 bits
    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER2),     0 << 2,     3 << 2);        //color order: YUYV
    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER2),     0 << 2,     3 << 2);        //color order: YUYV
    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_INTERRUPT_SETTING_REGISTER),    0x3,        0x3);           //interrupt mode

    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_ERROR_DETECT_SETTING_REGISTER), 0xffffffff, 0xffffffff);    //error detect
    ithWriteRegMaskA(   _GetAddress(DEV_ID, CAP_GENERAL_SETTING_REGISTER39),    0x0,        0x3);           // unfire
}
...
//=============================================================================
void
ithAVSync_CounterCtrl(CAPTURE_DEV_ID DEV_ID, AV_SYNC_COUNTER_CTRL mode, MMP_UINT16 divider)
{
...
void
ithAVSync_CounterReset(CAPTURE_DEV_ID DEV_ID, AV_SYNC_COUNTER_CTRL mode)
{
    ithWriteRegMaskA(_GetAddress(DEV_ID, CAP_AV_SYNC_SETTING_REGISTER0), (mode & 0x001F), 0x001F);
}

MMP_UINT32
ithAVSync_CounterLatch(CAPTURE_DEV_ID DEV_ID, AV_SYNC_COUNTER_CTRL mode)
{
    ithWriteRegMaskA(_GetAddress(DEV_ID, CAP_AV_SYNC_SETTING_REGISTER0), (mode & 0x001F), 0x001F);
}

MMP_UINT32
ithAVSync_CounterRead(CAPTURE_DEV_ID DEV_ID, AV_SYNC_COUNTER_CTRL mode)
{
    MMP_UINT32 value = 0;
...
MMP_BOOL
ithAVSync_MuteDetect(CAPTURE_DEV_ID DEV_ID)
{
    MMP_UINT32 value;
...
MMP_UINT32
ithCap_Get_Detected_Width(CAPTURE_DEV_ID DEV_ID)
{
    MMP_RESULT  result = MMP_SUCCESS;
...
MMP_UINT32
ithCap_Get_Detected_Height(CAPTURE_DEV_ID DEV_ID)
{
    MMP_RESULT  result = MMP_SUCCESS;
    MMP_UINT32  data;
...
MMP_UINT32
ithCap_Get_Detected_Interleave(CAPTURE_DEV_ID DEV_ID)
{
    MMP_RESULT  result = MMP_SUCCESS;
    MMP_UINT32  data;
...
void
ithCap_Dump_Reg(CAPTURE_DEV_ID DEV_ID)
{
    MMP_UINT32 i, data;
