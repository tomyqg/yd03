...
#define REG_I2C_CONTROL                    (ITH_IIC_BASE + 0x00)
#define REG_I2C_STATUS                     (ITH_IIC_BASE + 0x04)
#define REG_I2C_CLOCK_DIV                  (ITH_IIC_BASE + 0x08)
#define REG_I2C_DATA                       (ITH_IIC_BASE + 0x0C)
#define REG_I2C_SLAVE_ADDR                 (ITH_IIC_BASE + 0x10)
#define REG_I2C_GLITCH                     (ITH_IIC_BASE + 0x14)
#define REG_I2C_BUS_MONITOR                (ITH_IIC_BASE + 0x18)
#define REG_I2C_REV_NUMBER                 (ITH_IIC_BASE + 0x30)
#define REG_I2C_FEATURE                    (ITH_IIC_BASE + 0x34)
