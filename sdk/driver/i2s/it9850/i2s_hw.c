    ...
    uint32_t size32)
{
    ...
    /* NOTE: minus one for hardware design */
    _REG_Write32(I2S_REG_RX_BUF_SIZE, size32 - 1);
}
...
{
    /* NOTE: add one for hardware design */
    return _REG_Read32(I2S_REG_RX_BUF_SIZE) + 1;
}
...
_I2S_SetRxBufRdPtr(
    uint32_t ptr32)
{
    _REG_Write32(I2S_REG_RX_BUF_R_PTR, ptr32);
}
...
_I2S_GetRxBufRdPtr(
    void)
{
    return _REG_Read32(I2S_REG_RX_BUF_R_PTR);
}
...
_I2S_GetRxBufWrPtr(
    void)
{
    return _REG_Read32(I2S_REG_RX_BUF_W_PTR);
}
...
_I2S_SetRxHighWaterMark(
    uint32_t data32)
{
    _REG_Write32(I2S_REG_RX_H_WATER_MARK, data32);
}
...
{
    DEBUG_PRINT("I2S# %s\n", __func__);
    _REG_WriteMask16(I2S_REG_FADE_OUT_SET,
        ((fading_step     & N04_BITS_MSK) << I2S_POS_FADE_STEP)
      | ((fading_duration & N08_BITS_MSK) << I2S_POS_FADE_CYCLE),
        I2S_POS_FADE_STEP | I2S_POS_FADE_CYCLE);
    _REG_SetBit16(I2S_REG_EN_FADE_IN_OUT, I2S_POS_EN_FADE_IN_OUT);
}
...
{
    DEBUG_PRINT("I2S# %s\n", __func__);
    _REG_ClrBit16(I2S_REG_EN_FADE_IN_OUT, I2S_POS_EN_FADE_IN_OUT);
}
