...
namespace httpserver
{
    ...
    protected:
        ...
        std::string content;	// 要回應給客戶端的內容，資料來源來自 http_response_builder
        int response_code;
        bool autodelete;
        std::string realm;
        std::string opaque;
        ...
        int fp;
        std::string filename;
        std::map<std::string, std::string, http::header_comparator> headers;		// 資料來源來自 http_response_builder
        std::map<std::string, std::string, http::header_comparator> footers;		// 資料來源來自 http_response_builder
        std::map<std::string, std::string, http::header_comparator> cookies;		// 資料來源來自 http_response_builder
