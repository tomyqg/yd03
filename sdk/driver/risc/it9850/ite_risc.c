    ...
    int             targetCpu)
{
    ...
    switch(targetCpu)
    {
        ...
        case RISC2_CPU:
        {
            ...
            ithSetRegBitA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, ITH_GPIO_EN_AHB_SRAM_POS);
    ...
    int             targetCpu)
{
    ...
    switch(targetCpu)
    {
        ...
        case RISC2_CPU:
        {
            ...
            ithClearRegBitA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, ITH_GPIO_EN_AHB_SRAM_POS);
            break;
        }
        default:
            return;
