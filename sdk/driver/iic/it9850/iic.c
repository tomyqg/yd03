    ...
    uint32_t    delay)
{
    ...
    if (IicDevices[port].refCount == 1)
    {
        ...
        {
#if (defined CFG_IIC0_GPIO_CONFIG_1)
            ithGpioSetMode(ITH_GPIO_PIN23, ITH_GPIO_MODE3);
            ithGpioSetMode(ITH_GPIO_PIN24, ITH_GPIO_MODE3);
#elif (defined CFG_IIC0_GPIO_CONFIG_2)
    #if (defined CFG_CHIP_PKG_IT9856)
            ithGpioSetMode(ITH_GPIO_PIN88, ITH_GPIO_MODE1);
            ithGpioSetMode(ITH_GPIO_PIN89, ITH_GPIO_MODE1);
    #else   //defined CHIP_PKG_IT9852||CHIP_PKG_IT9854
            ithGpioSetMode(ITH_GPIO_PIN98, ITH_GPIO_MODE1);
            ithGpioSetMode(ITH_GPIO_PIN99, ITH_GPIO_MODE1);
    #endif
#elif (defined CFG_IIC0_GPIO_CONFIG_3)
            ithGpioSetMode(ITH_GPIO_PIN11, ITH_GPIO_MODE3);
            ithGpioSetMode(ITH_GPIO_PIN12, ITH_GPIO_MODE3);
#endif
        }
        else
        {
#if (defined CFG_IIC1_GPIO_CONFIG_1)
            ithGpioSetMode(ITH_GPIO_PIN25, ITH_GPIO_MODE3);
            ithGpioSetMode(ITH_GPIO_PIN26, ITH_GPIO_MODE3);
#elif (defined CFG_IIC1_GPIO_CONFIG_2)
    #if (defined CFG_CHIP_PKG_IT9856)
            ithGpioSetMode(ITH_GPIO_PIN88, ITH_GPIO_MODE2);
            ithGpioSetMode(ITH_GPIO_PIN89, ITH_GPIO_MODE2);
    #else   //defined CHIP_PKG_IT9852||CHIP_PKG_IT9854 // pin 98 99
            ithGpioSetMode(ITH_GPIO_PIN98, ITH_GPIO_MODE2);
            ithGpioSetMode(ITH_GPIO_PIN99, ITH_GPIO_MODE2);
    #endif
#elif (defined CFG_IIC1_GPIO_CONFIG_3)
            ithGpioSetMode(ITH_GPIO_PIN69, ITH_GPIO_MODE3);
            ithGpioSetMode(ITH_GPIO_PIN70, ITH_GPIO_MODE3);
#endif
        }
