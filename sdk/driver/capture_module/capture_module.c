...
{
	//module 1
	if (CFG_CAPTURE_MODULE_NAME == "hm1375.c")
    {   
		if(strcmp(moduleName,"hm1375.c") == 0)
			return (CaptureModuleDriver)HM1375CaptureModuleDriver_Create();
    }
	if(CFG_CAPTURE_MODULE_NAME == "gt5110e1.c")
	{
		if(strcmp(moduleName,"gt5110e1.c") == 0)
	...
	if(CFG_CAPTURE_MODULE_NAME == "gc0308.c")
	{
		if (strcmp(moduleName,"gc0308.c") == 0)
			return (CaptureModuleDriver)GC0308CaptureModuleDriver_Create();
	}    
	//module 2
	#ifdef CFG_SENCOND_CAPTURE_MODULE_ENABLE
	if(CFG_SENCOND_CAPTURE_MODULE_NAME == "hm1375.c")
	{
		if(strcmp(moduleName,"hm1375.c") == 0)
			return (CaptureModuleDriver)HM1375CaptureModuleDriver_Create();
	}
	if(CFG_SENCOND_CAPTURE_MODULE_NAME == "gt5110e1.c")
	{
		if(strcmp(moduleName,"gt5110e1.c") == 0)
			return (CaptureModuleDriver)GT5110E1CaptureModuleDriver_Create();
	}
	...
	if(CFG_SENCOND_CAPTURE_MODULE_NAME == "gc0308.c")
	{
		if (strcmp(moduleName,"gc0308.c") == 0)
			return (CaptureModuleDriver)GC0308CaptureModuleDriver_Create();
	}  
...
void ithModule_ForCaptureDriverSetting(CaptureModuleDriver self, CAP_CONTEXT *Capctxt)
{
    if (self)
