...
void itp_codec_playback_amp_volume_down(void)
{
    ...
    if      (0xA8 <= curr_out1_volume && curr_out1_volume <= 0xAF) itp_codec_playback_set_direct_vol(0xA7);      /* -3 dB */
    else if (0xA0 <= curr_out1_volume && curr_out1_volume <= 0xA7) itp_codec_playback_set_direct_vol(0x9F);                                                            /* -6 dB */
    else if (0x98 <= curr_out1_volume && curr_out1_volume <= 0x9F) itp_codec_playback_set_direct_vol(0x97);                                                            /* -9 dB */
    else if (0x90 <= curr_out1_volume && curr_out1_volume <= 0x97) itp_codec_playback_set_direct_vol(0x8F);                                                            /* -12 dB */
    else if (0x70 <= curr_out1_volume && curr_out1_volume <= 0x8F) itp_codec_playback_set_direct_vol(0x6F);                                                            /* -24 dB */
    else if (0x60 <= curr_out1_volume && curr_out1_volume <= 0x6F) itp_codec_playback_set_direct_vol(0x5F);                                                            /* -30 dB */
    else if (0x50 <= curr_out1_volume && curr_out1_volume <= 0x5F) itp_codec_playback_set_direct_vol(0x58);                                                            /* -39 dB */
}
...
void itp_codec_playback_amp_volume_up(void)
{
    ...
    if      (0xA7 <= curr_out1_volume && curr_out1_volume <= 0xAE) itp_codec_playback_set_direct_vol(0xAF);      /* +0 dB */
    else if (0x9F <= curr_out1_volume && curr_out1_volume <= 0xA6) itp_codec_playback_set_direct_vol(0xA7);                                                            /* -3 dB */
    else if (0x97 <= curr_out1_volume && curr_out1_volume <= 0x9E) itp_codec_playback_set_direct_vol(0x9F);                                                            /* -6 dB */
    else if (0x8F <= curr_out1_volume && curr_out1_volume <= 0x96) itp_codec_playback_set_direct_vol(0x97);                                                            /* -9 dB */
    else if (0x6F <= curr_out1_volume && curr_out1_volume <= 0x8E) itp_codec_playback_set_direct_vol(0x8F);                                                            /* -12 dB */
    else if (0x5F <= curr_out1_volume && curr_out1_volume <= 0x6E) itp_codec_playback_set_direct_vol(0x6F);                                                            /* -24 dB */
    else if (0x57 <= curr_out1_volume && curr_out1_volume <= 0x5E) itp_codec_playback_set_direct_vol(0x5F);                                                            /* -30 dB */
}
