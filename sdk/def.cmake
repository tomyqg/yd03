...
elseif (DEFINED CFG_CHIP_PKG_IT970)
    add_definitions(
        -DCFG_CHIP_PKG_IT970
        -DCFG_OSC_CLK=12000000
        -DCFG_RTC_EXTCLK=12000000
...
if (DEFINED CFG_OPENVG_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_OPENVG_SW)
...
if (DEFINED CFG_AUDIO_ENABLE)
    ...
    if(DEFINED CFG_ENABLE_RECV_FILTER)
        add_definitions(
            -DENABLE_RECV_FILTER
        )
    endif()
...
if (DEFINED CFG_CAPTURE_MODULE_ENABLE)
	...
	add_definitions(
        ...
        -DCFG_SENCOND_CAPTURE_WIDTH=${CFG_SENCOND_CAPTURE_WIDTH}
        -DCFG_SENCOND_CAPTURE_HEIGHT=${CFG_SENCOND_CAPTURE_HEIGHT}
	)
	endif()
    set(CFG_BUILD_CAPTURE 1)
