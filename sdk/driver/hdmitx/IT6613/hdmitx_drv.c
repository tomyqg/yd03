...
#define Switch_HDMITX_Bank_6613(x)   HDMITX_WriteI2C_Byte_6613(0x0f,(x)&1)
...
void
HDMITX_InitInstance_6613(INSTANCE *pInstance)
{
...
static void C6613_Check_EMEM_sts()
{
    ...
    Switch_HDMITX_Bank_6613(0);
    HDMITX_WriteI2C_Byte_6613(0xF8,0xC3);//unlock register
    HDMITX_WriteI2C_Byte_6613(0xF8,0xA5);//unlock register

    HDMITX_WriteI2C_Byte_6613(0x22,0x00);


    HDMITX_WriteI2C_Byte_6613(0x10,0x03);//

    HDMITX_WriteI2C_Byte_6613(0x11,0xA0);
    HDMITX_WriteI2C_Byte_6613(0x12,0x00);//
    HDMITX_WriteI2C_Byte_6613(0x13,0x08);
    HDMITX_WriteI2C_Byte_6613(0x14,0x00);//
    HDMITX_WriteI2C_Byte_6613(0x15,0x00);//
    // delay1ms(200);
    ...
    {
        delay1ms(1);
        uc = HDMITX_ReadI2C_Byte_6613(0x1c) ;
        if( 0 != (0x80 & uc))
        {
    ...
    // HDMITX_WriteI2C_Byte_6613(0x04,0x3F);     //reset all reg
    HDMITX_WriteI2C_Byte_6613(0xF8,0xFF);//lock register
}
...
static void InitHDMITX_HDCPROM()
{
    ...
    if(Instance[0].TxEMEMStatus==TRUE){
            // with internal eMem
            HDMITX_WriteI2C_Byte_6613(REG_TX_ROM_HEADER,0xE0);
            HDMITX_WriteI2C_Byte_6613(REG_TX_LISTCTRL,0x48);
    }else{
        // with external ROM
        HDMITX_WriteI2C_Byte_6613(REG_TX_ROM_HEADER,0xA0);
        HDMITX_WriteI2C_Byte_6613(REG_TX_LISTCTRL,0x00);
    }
    HDMITX_WriteI2C_Byte_6613(0xF8,0xFF);//lock register
}
...
void InitHDMITX_6613()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CTRL,Instance[0].bIntType);
    Instance[0].bIntPOL = (Instance[0].bIntType&B_INTPOL_ACTH)?TRUE:FALSE ;

    C6613_Check_EMEM_sts();

    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,B_REF_RST_HDMITX|B_VID_RST_HDMITX|B_AUD_RST_HDMITX|B_AREF_RST|B_HDCP_RST_HDMITX);
    delay1ms(1);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,B_VID_RST_HDMITX|B_AUD_RST_HDMITX|B_AREF_RST|B_HDCP_RST_HDMITX);

    // Avoid power loading in un play status.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_DRV_CTRL,B_AFE_DRV_RST|B_AFE_DRV_PWD);
    //////////////////////////////////////////////////////////////////
    // Setup HDCP ROM
    //////////////////////////////////////////////////////////////////
    InitHDMITX_HDCPROM();
    ...
    //HDMITX_WriteI2C_Byte_6613(REG_TX_INT_MASK1,0xB2);
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_MASK1,0x30);
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_MASK2,0xF8);
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_MASK3,0x37);
    Switch_HDMITX_Bank_6613(0);
    DISABLE_NULL_PKT();
    DISABLE_ACP_PKT();
    DISABLE_ISRC1_PKT();
    ...
    //////////////////////////////////////////////////////////////////
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL1,Instance[0].bOutputAudioMode); // regE1 bOutputAudioMode should be loaded from ROM image.


    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR0,0xFF);
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR1,0xFF);
    intclr = (HDMITX_ReadI2C_Byte_6613(REG_TX_SYS_STATUS))|B_CLR_AUD_CTS | B_INTACTDONE ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,intclr); // clear interrupt.
    intclr &= ~(B_INTACTDONE);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,intclr); // INTACTDONE reset to zero.
    {
        ULONG n=6144L;
        Switch_HDMITX_Bank_6613(1);
        HDMITX_WriteI2C_Byte_6613(REGPktAudN0,(BYTE)((n)&0xFF));
        HDMITX_WriteI2C_Byte_6613(REGPktAudN1,(BYTE)((n>>8)&0xFF));
        HDMITX_WriteI2C_Byte_6613(REGPktAudN2,(BYTE)((n>>16)&0xF));
        Switch_HDMITX_Bank_6613(0);
        HDMITX_WriteI2C_Byte_6613(0xc4,0xfe);
        HDMITX_OrREG_Byte_6613(REG_TX_PKT_SINGLE_CTRL,(1<<4)|(1<<5));
    }
...
static void WaitTxVidStable()
{
    ...
    {
        delay1ms(15);
        if((HDMITX_ReadI2C_Byte_6613(REG_TX_SYS_STATUS) & B_TXVIDSTABLE) == 0 )
        {
            continue ;
        }
        delay1ms(15);
...
BOOL EnableVideoOutput_6613(VIDEOPCLKLEVEL level,BYTE inputColorMode,BYTE outputColorMode,BYTE bHDMI)
{
    ...
    Switch_HDMITX_Bank_6613(1);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB1,0x00);
    Switch_HDMITX_Bank_6613(0);
    ...
    if(Instance[0].bHDMIMode)
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_HDMI_MODE,B_TX_HDMI_MODE);
    }
    else
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_HDMI_MODE,B_TX_DVI_MODE);
    }

#ifdef INVERT_VID_LATCHEDGE
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_CLK_CTRL1);
    uc |= B_VDO_LATCH_EDGE ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_CLK_CTRL1, uc);
#endif

//    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,          B_AUD_RST_HDMITX|B_AREF_RST|B_HDCP_RST_HDMITX);
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR0,0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR1,B_CLR_VIDSTABLE);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,B_INTACTDONE);
...
//    unsigned long N ;
    ...
    {
        Switch_HDMITX_Bank_6613(1);
        HDMITX_WriteI2C_Byte_6613(REGPktAudCTS0,0x50);
        HDMITX_WriteI2C_Byte_6613(REGPktAudCTS1,0x73);
        HDMITX_WriteI2C_Byte_6613(REGPktAudCTS2,0x00);

        HDMITX_WriteI2C_Byte_6613(REGPktAudN0,0);
        HDMITX_WriteI2C_Byte_6613(REGPktAudN1,0x18);
        HDMITX_WriteI2C_Byte_6613(REGPktAudN2,0);
        Switch_HDMITX_Bank_6613(0);

        HDMITX_WriteI2C_Byte_6613(0xC5, 2); // D[1] = 0, HW auto count CTS
    }
    else
    {
    ...
    else
    {
        ...
        HDMITX_WriteI2C_Byte_6613(REGPktAudN2,(BYTE)((N>>16)&0xF));
        Switch_HDMITX_Bank_6613(0);
        HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_SINGLE_CTRL,0); // D[1] = 0,HW auto count CTS
    }
    */

    //HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,~(B_AUD_RST_HDMITX|B_AREF_RST));
    SetAudioFormat(ChannelNumber,bAudioChannelEnable,bAudioSampleFreq,bAudSWL,bSPDIF);

    #ifdef DEBUG
    DumpCatHDMITXReg_6613();
    #endif // DEBUG
    return TRUE ;
}
#endif
...
BOOL
GetEDIDData_6613(int EDIDBlockID,BYTE *pEDIDData)
{
    if(!pEDIDData)
    {
        return FALSE ;
    ...
    if(ReadEDID_6613(pEDIDData,EDIDBlockID/2,(EDIDBlockID%2)*128,128) == ER_FAIL)
    {
        return FALSE ;
    }
...
EnableHDCP_6613(BYTE bEnable)
{
    ...
    if(bEnable)
    {
        ...
        {
            printf("hdmitx_drv.c(%d), 6613 autenticate is success\n", __LINE__);
        }
    }
    else
    {
...
BYTE
CheckHDMITX_6613(BYTE *pHPD,BYTE *pHPDChange)
{
    ...
    sysstat = HDMITX_ReadI2C_Byte_6613(REG_TX_SYS_STATUS);
    ...
    if(sysstat & B_INT_ACTIVE)
    {
        ...
        intdata1 = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT1);
...
#endif
            HDMITX_OrREG_Byte_6613(REG_TX_SW_RST,(B_AUD_RST_HDMITX|B_AREF_RST));
            HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,~(B_AUD_RST_HDMITX|B_AREF_RST));
        ...
        if(intdata1 & (B_INT_HPD_PLUG/*|B_INT_RX_SENSE*/))
        {
            ...
            if(HPD == FALSE)
            {
                HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,B_AREF_RST|B_VID_RST_HDMITX|B_AUD_RST_HDMITX|B_HDCP_RST_HDMITX);
                delay1ms(1);
                HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_DRV_CTRL,B_AFE_DRV_RST|B_AFE_DRV_PWD);
                //HDMITX_DEBUG_PRINTF(("Unplug,%x %x\n",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST),(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AFE_DRV_CTRL)));
            }
        }


        intdata2 = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT2);
        ...
        if(intdata2 & B_INT_AUTH_DONE)
        {
            ...
            HDMITX_OrREG_Byte_6613(REG_TX_INT_MASK2,(BYTE)B_T_AUTH_DONE_MASK);
        ...
        intdata3 = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT3);
        ...
        HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR0,0xFF);
        HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR1,0xFF);
        intclr3 = (HDMITX_ReadI2C_Byte_6613(REG_TX_SYS_STATUS))|B_CLR_AUD_CTS | B_INTACTDONE ;
        HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,intclr3); // clear interrupt.
        intclr3 &= ~(B_INTACTDONE);
        HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,intclr3); // INTACTDONE reset to zero.
    }
    else
    {
        if(pHPDChange)
...
{
    BYTE uc = HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST) | B_VID_RST_HDMITX ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,uc);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_DRV_CTRL,B_AFE_DRV_RST|B_AFE_DRV_PWD);
}
...
{
    //BYTE uc = (HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST) | (B_AUD_RST_HDMITX | B_AREF_RST)) ;
    //HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,uc);
    HDMITX_OrReg_Byte_6613(REG_TX_SW_RST,(B_AUD_RST_HDMITX | B_AREF_RST));
}
...
BOOL
EnableAVIInfoFrame_6613(BYTE bEnable,BYTE *pAVIInfoFrame)
{
    if(!bEnable)
    {
        DISABLE_AVI_INFOFRM_PKT();
...
BOOL
EnableAudioInfoFrame_6613(BYTE bEnable,BYTE *pAudioInfoFrame)
{
    if(!bEnable)
    {
        DISABLE_AVI_INFOFRM_PKT();
...
void
SetAVMute_6613(BYTE bEnable)
{
    BYTE uc ;

    Switch_HDMITX_Bank_6613(0);
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_GCP);
    uc &= ~B_TX_SETAVMUTE ;
    uc |= bEnable?B_TX_SETAVMUTE:0 ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_GCP,uc);
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_GENERAL_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}

void
SetOutputColorDepthPhase_6613(BYTE ColorDepth,BYTE bPhase)
{
    BYTE uc ;
    BYTE bColorDepth ;
...
Get6613Reg(BYTE *pReg)
{
    ...
    {
        reg = i & 0xFF ;
        pReg[i] = HDMITX_ReadI2C_Byte_6613(reg);
    }
    Switch_HDMITX_Bank_6613(1);
        ...
        switch (inputDevice)
        {
            case TXIN_HDMIRX:
                if (id == VESA_GET_HDMIRX_DE)
                {
                    ...
                    Reg92 = (timingDE_6613.HDES & 0xFF);
                    Reg93 = (timingDE_6613.HDEE & 0xFF);
                    Reg94 = (((timingDE_6613.HDEE >> 8) << 4) | (timingDE_6613.HDES >> 8));

                    Reg9A = (timingDE_6613.VDES & 0xFF);
                    Reg9B = (timingDE_6613.VDEE & 0xFF);
                    Reg9C = (((timingDE_6613.VDEE >> 8) << 4) | (timingDE_6613.VDES >> 8));
                    
                    Reg9D = Reg9E = Reg9F = 0xFF;
                                        
                    Switch_HDMITX_Bank_6613(0);
                    HDMITX_WriteI2C_Byte_6613(0x90, Reg90);
                    HDMITX_WriteI2C_Byte_6613(0x92, Reg92);
                    HDMITX_WriteI2C_Byte_6613(0x93, Reg93);
                    HDMITX_WriteI2C_Byte_6613(0x94, Reg94);
                    HDMITX_WriteI2C_Byte_6613(0x9A, Reg9A);
                    HDMITX_WriteI2C_Byte_6613(0x9B, Reg9B);
                    HDMITX_WriteI2C_Byte_6613(0x9C, Reg9C);
                    HDMITX_WriteI2C_Byte_6613(0x9D, Reg9D);
                    HDMITX_WriteI2C_Byte_6613(0x9E, Reg9E);
                    HDMITX_WriteI2C_Byte_6613(0x9F, Reg9F);                    
                } 
                else
                {
                    ...
                    Switch_HDMITX_Bank_6613(0);
                    HDMITX_WriteI2C_Byte_6613(0x90, DeGen_Table[i].Reg90);
                    HDMITX_WriteI2C_Byte_6613(0x92, DeGen_Table[i].Reg92);
                    HDMITX_WriteI2C_Byte_6613(0x93, DeGen_Table[i].Reg93);
                    HDMITX_WriteI2C_Byte_6613(0x94, DeGen_Table[i].Reg94);
                    HDMITX_WriteI2C_Byte_6613(0x9A, DeGen_Table[i].Reg9A);
                    HDMITX_WriteI2C_Byte_6613(0x9B, DeGen_Table[i].Reg9B);
                    HDMITX_WriteI2C_Byte_6613(0x9C, DeGen_Table[i].Reg9C);
                    HDMITX_WriteI2C_Byte_6613(0x9D, DeGen_Table[i].Reg9D);
                    HDMITX_WriteI2C_Byte_6613(0x9E, DeGen_Table[i].Reg9E);
                    HDMITX_WriteI2C_Byte_6613(0x9F, DeGen_Table[i].Reg9F);
                }
                return TRUE;                        
            ...
            case TXIN_CVBS:
                ...
                Switch_HDMITX_Bank_6613(0);
                HDMITX_WriteI2C_Byte_6613(0x90, CVBS_DeGen_Table[i].Reg90);
                HDMITX_WriteI2C_Byte_6613(0x91, CVBS_DeGen_Table[i].Reg91);
                HDMITX_WriteI2C_Byte_6613(0x92, CVBS_DeGen_Table[i].Reg92);
                HDMITX_WriteI2C_Byte_6613(0x93, CVBS_DeGen_Table[i].Reg93);
                HDMITX_WriteI2C_Byte_6613(0x94, CVBS_DeGen_Table[i].Reg94);
                HDMITX_WriteI2C_Byte_6613(0x95, CVBS_DeGen_Table[i].Reg95);
                HDMITX_WriteI2C_Byte_6613(0x96, CVBS_DeGen_Table[i].Reg96);
                HDMITX_WriteI2C_Byte_6613(0x97, CVBS_DeGen_Table[i].Reg97);
                HDMITX_WriteI2C_Byte_6613(0x9A, CVBS_DeGen_Table[i].Reg9A);
                HDMITX_WriteI2C_Byte_6613(0x9B, CVBS_DeGen_Table[i].Reg9B);
                HDMITX_WriteI2C_Byte_6613(0x9C, CVBS_DeGen_Table[i].Reg9C);
                HDMITX_WriteI2C_Byte_6613(0x9D, CVBS_DeGen_Table[i].Reg9D);
                HDMITX_WriteI2C_Byte_6613(0x9E, CVBS_DeGen_Table[i].Reg9E);
                HDMITX_WriteI2C_Byte_6613(0x9F, CVBS_DeGen_Table[i].Reg9F);
                HDMITX_WriteI2C_Byte_6613(0xA0, CVBS_DeGen_Table[i].RegA0);
                HDMITX_WriteI2C_Byte_6613(0xA1, CVBS_DeGen_Table[i].RegA1);
                HDMITX_WriteI2C_Byte_6613(0xA2, CVBS_DeGen_Table[i].RegA2);
                HDMITX_WriteI2C_Byte_6613(0xA3, CVBS_DeGen_Table[i].RegA3); 
                return TRUE;                    
            ...
            case TXIN_YPBPR: 
                ...
                Switch_HDMITX_Bank_6613(0);
                HDMITX_WriteI2C_Byte_6613(0x90, YPBPR_DeGen_Table[i].Reg90);
                HDMITX_WriteI2C_Byte_6613(0x91, YPBPR_DeGen_Table[i].Reg91);
                HDMITX_WriteI2C_Byte_6613(0x92, YPBPR_DeGen_Table[i].Reg92);
                HDMITX_WriteI2C_Byte_6613(0x93, YPBPR_DeGen_Table[i].Reg93);
                HDMITX_WriteI2C_Byte_6613(0x94, YPBPR_DeGen_Table[i].Reg94);
                HDMITX_WriteI2C_Byte_6613(0x95, YPBPR_DeGen_Table[i].Reg95);
                HDMITX_WriteI2C_Byte_6613(0x96, YPBPR_DeGen_Table[i].Reg96);
                HDMITX_WriteI2C_Byte_6613(0x97, YPBPR_DeGen_Table[i].Reg97);
                HDMITX_WriteI2C_Byte_6613(0x9A, YPBPR_DeGen_Table[i].Reg9A);
                HDMITX_WriteI2C_Byte_6613(0x9B, YPBPR_DeGen_Table[i].Reg9B);
                HDMITX_WriteI2C_Byte_6613(0x9C, YPBPR_DeGen_Table[i].Reg9C);
                HDMITX_WriteI2C_Byte_6613(0x9D, YPBPR_DeGen_Table[i].Reg9D);
                HDMITX_WriteI2C_Byte_6613(0x9E, YPBPR_DeGen_Table[i].Reg9E);
                HDMITX_WriteI2C_Byte_6613(0x9F, YPBPR_DeGen_Table[i].Reg9F);
                HDMITX_WriteI2C_Byte_6613(0xA0, YPBPR_DeGen_Table[i].RegA0);
                HDMITX_WriteI2C_Byte_6613(0xA1, YPBPR_DeGen_Table[i].RegA1);
                HDMITX_WriteI2C_Byte_6613(0xA2, YPBPR_DeGen_Table[i].RegA2);
                HDMITX_WriteI2C_Byte_6613(0xA3, YPBPR_DeGen_Table[i].RegA3);                               
                return TRUE;
...
BOOL
ProgramSyncEmbeddedByVIC_6613(BYTE VIC,BYTE bInputSignalType)
{
    int i ;
    // if Embedded Video,need to generate timing with pattern register

    HDMITX_DEBUG_PRINTF(("ProgramSyncEmbeddedByVIC_6613(%d,%x)\n",(int)VIC,(int)bInputSignalType));
    ...
    if( bInputSignalType & T_MODE_SYNCEMB )
    {
        ...
        HDMITX_WriteI2C_Byte_6613(REG_TX_HVPol,SyncEmbTable[i].RegHVPol); // Reg90
        HDMITX_WriteI2C_Byte_6613(REG_TX_HfPixel,SyncEmbTable[i].RegHfPixel); // Reg91

        HDMITX_WriteI2C_Byte_6613(REG_TX_HSSL,SyncEmbTable[i].RegHSSL); // Reg95
        HDMITX_WriteI2C_Byte_6613(REG_TX_HSEL,SyncEmbTable[i].RegHSEL); // Reg96
        HDMITX_WriteI2C_Byte_6613(REG_TX_HSH,SyncEmbTable[i].RegHSH); // Reg97
        HDMITX_WriteI2C_Byte_6613(REG_TX_VSS1,SyncEmbTable[i].RegVSS1); // RegA0
        HDMITX_WriteI2C_Byte_6613(REG_TX_VSE1,SyncEmbTable[i].RegVSE1); // RegA1

        HDMITX_WriteI2C_Byte_6613(REG_TX_VSS2,SyncEmbTable[i].RegVSS2); // RegA2
        HDMITX_WriteI2C_Byte_6613(REG_TX_VSE2,SyncEmbTable[i].RegVSE2); // RegA3
    }
...
BOOL
ProgramSyncEmbeddedByTiming_6613(VIDEO_Timing *pVTiming,BYTE bInputSignalType)
{
    unsigned int temp, t2 ;
    BYTE uc ;
    // if Embedded Video,need to generate timing with pattern register

    HDMITX_DEBUG_PRINTF(("ProgramSyncEmbeddedByTiming_6613(%dx%d(%dx%d),%x)\n",
    ...
    if( bInputSignalType & T_MODE_SYNCEMB )
    {
        ...
        if( pVTiming->ScanMode == INTERLACE )
        {
            ...
            HDMITX_WriteI2C_Byte_6613(REG_TX_HVPol,uc); // Reg90
            temp >>= 4 ;
            uc = (BYTE)(temp);
            HDMITX_WriteI2C_Byte_6613(REG_TX_HfPixel,uc); // Reg91
        }
        else
        {
            uc = 0xF0 ;
            ...
            HDMITX_WriteI2C_Byte_6613(REG_TX_HfPixel,0xFF); // Reg91
        }
        ...
        uc = (BYTE)temp & 0xFF ;
        HDMITX_WriteI2C_Byte_6613(REG_TX_HSSL,uc); // Reg95
        uc = (BYTE)t2 & 0xFF ;
        HDMITX_WriteI2C_Byte_6613(REG_TX_HSEL,uc); // Reg96

        temp >>= 8 ; temp &= 0xF ;
        t2 >>= 4 ; t2 &= 0xF0 ;
        temp |= t2 ;
        uc =  (BYTE)(temp);
        HDMITX_WriteI2C_Byte_6613(REG_TX_HSH,uc); // Reg97

        temp = pVTiming->VFrontPorch ;
        t2  = temp + pVTiming->VSyncWidth ;

        uc = (BYTE)temp & 0xFF ;
        HDMITX_WriteI2C_Byte_6613(REG_TX_VSS1,uc); // RegA0

        uc = (BYTE)((t2&0xF)<<4);
        uc |= (BYTE)(temp >> 8) ;

        HDMITX_WriteI2C_Byte_6613(REG_TX_VSE1,uc); // RegA1
        ...
        if( pVTiming->ScanMode == INTERLACE )
        {
            ...
            uc = (BYTE)temp&0xFF ;
            HDMITX_WriteI2C_Byte_6613(REG_TX_VSS2,uc); // RegA2

            temp >>= 8 ; temp &= 0xF ;
            t2 &= 0xF ; t2 <<= 4 ;
            temp |= t2 ;
            uc = (BYTE)temp ;
            HDMITX_WriteI2C_Byte_6613(REG_TX_VSE2,uc); // RegA3
        }
        else
        {
            HDMITX_WriteI2C_Byte_6613(REG_TX_VSS2,0xFF); // RegA2
            HDMITX_WriteI2C_Byte_6613(REG_TX_VSE2,0xFF); // RegA3
        }
        HDMITX_DEBUG_PRINTF(("REG = {0x%02X,0x%02X,0x%02X,0x%02X,0x%02X,0x%02X,0x%02X,0x%02X,0x%02X}\n",
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_HVPol) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_HfPixel) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_HSSL) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_HSEL) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_HSH) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_VSS1) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_VSE1) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_VSS2) ,
            (int)HDMITX_ReadI2C_Byte_6613(REG_TX_VSE2) )) ;
...
//    HDMITX_DEBUG_PRINTF(("SetInputMode(%02X,%02X)\n",InputMode,bInputSignalType));
    ...
    ucData = HDMITX_ReadI2C_Byte_6613(REG_TX_INPUT_MODE);
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_INPUT_MODE,ucData);
}
...
SetCSCScale(BYTE bInputMode,BYTE bOutputMode)
{
    ...
    if(csc == B_HDMITX_CSC_RGB2YUV)
    {
        ...
        case F_MODE_ITU709|F_MODE_16_235:
            ...
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_16_235,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_RGB2YUV_ITU709_16_235,SIZEOF_CSCMTX);
            break ;
        case F_MODE_ITU709|F_MODE_0_255:
            HDMITX_DEBUG_PRINTF(("ITU709 0-255 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_0_255,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_RGB2YUV_ITU709_0_255,SIZEOF_CSCMTX);
            break ;
        case F_MODE_ITU601|F_MODE_16_235:
            HDMITX_DEBUG_PRINTF(("ITU601 16-235 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_16_235,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_RGB2YUV_ITU601_16_235,SIZEOF_CSCMTX);
            break ;
        case F_MODE_ITU601|F_MODE_0_255:
        default:
            HDMITX_DEBUG_PRINTF(("ITU601 0-255 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_0_255,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_RGB2YUV_ITU601_0_255,SIZEOF_CSCMTX);
            break ;
        }
    ...
    if (csc == B_HDMITX_CSC_YUV2RGB)
    {
        ...
        case F_MODE_ITU709|F_MODE_16_235:
            HDMITX_DEBUG_PRINTF(("ITU709 16-235 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_16_235,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_YUV2RGB_ITU709_16_235,SIZEOF_CSCMTX);
            break ;
        case F_MODE_ITU709|F_MODE_0_255:
            HDMITX_DEBUG_PRINTF(("ITU709 0-255 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_0_255,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_YUV2RGB_ITU709_0_255,SIZEOF_CSCMTX);
            break ;
        case F_MODE_ITU601|F_MODE_16_235:
            HDMITX_DEBUG_PRINTF(("ITU601 16-235 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_16_235,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_YUV2RGB_ITU601_16_235,SIZEOF_CSCMTX);
            break ;
        case F_MODE_ITU601|F_MODE_0_255:
        default:
            HDMITX_DEBUG_PRINTF(("ITU601 0-255 "));
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_YOFF,bTxCSCOffset_0_255,SIZEOF_CSCOFFSET);
            HDMITX_WriteI2C_ByteN_6613(REG_TX_CSC_MTX11_L,bTxCSCMtx_YUV2RGB_ITU601_0_255,SIZEOF_CSCMTX);
            break ;
        }
    }
    #endif
    ...
    ucData = HDMITX_ReadI2C_Byte_6613(REG_TX_CSC_CTRL) & ~(M_CSC_SEL|B_TX_DNFREE_GO|B_TX_EN_DITHER|B_TX_EN_UDFILTER);
    ucData |= filter|csc ;

    HDMITX_WriteI2C_Byte_6613(REG_TX_CSC_CTRL,ucData);
...
SetupAFE(VIDEOPCLKLEVEL level)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_DRV_CTRL,B_AFE_DRV_RST);/* 0x10 */
    // HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_DRV_CTRL,0x3);
    ...
    {
    case PCLK_HIGH:
        HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_XP_CTRL,0x88); // reg62
        HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_ISW_CTRL, 0x10); // reg63
        HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_IP_CTRL,0x84); // reg64
        break ;
    default:
        HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_XP_CTRL,0x18); // reg62
        HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_ISW_CTRL, 0x10); // reg63
        HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_IP_CTRL,0x0C); // reg64
        break ;
    }
    // 2009/01/15 modified by Jau-Chih.Tseng@ite.com.tw
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST);
    uc &= ~(B_REF_RST_HDMITX|B_VID_RST_HDMITX);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,uc);
    delay1ms(1);
    // HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,uc|B_VID_RST_HDMITX);
    // delay1ms(100);
    // HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,uc);
    //~Jau-Chih.Tseng@ite.com.tw
...
FireAFE()
{
    BYTE reg;
    Switch_HDMITX_Bank_6613(0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AFE_DRV_CTRL,0);

    for(reg = 0x61 ; reg <= 0x67 ; reg++)
    {
//        HDMITX_DEBUG_PRINTF(("Reg[%02X] = %02X\n",(int)reg,(int)HDMITX_ReadI2C_Byte_6613(reg)));
    }
}
...
//    HDMITX_DEBUG_PRINTF(("SetAudioFormat(%d channel,%02X,SampleFreq %d,AudSWL %d,%02X)\n",(int)NumChannel,(int)AudioEnable,(int)bSampleFreq,(int)AudSWL,(int)AudioCatCode));
    ...
    Switch_HDMITX_Bank_6613(0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0,AudioEnable&0xF0);

    HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,~(B_AUD_RST_HDMITX|B_AREF_RST));
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL1,Instance[0].bOutputAudioMode); // regE1 bOutputAudioMode should be loaded from ROM image.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_FIFOMAP,0xE4); // default mapping.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL3,(Instance[0].bAudioChannelSwap&0xF)|(AudioEnable&B_AUD_SPDIF));
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_SRCVALID_FLAT,SourceValid);

    // suggested to be 0x41

//     Switch_HDMITX_Bank_6613(1);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_MODE,0 |((NumChannel == 1)?1:0)); // 2 audio channel without pre-emphasis,if NumChannel set it as 1.
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CAT,AudioCatCode);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_SRCNUM,SoruceNum);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUD0CHST_CHTNUM,0x21);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUD1CHST_CHTNUM,0x43);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUD2CHST_CHTNUM,0x65);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUD3CHST_CHTNUM,0x87);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CA_FS,0x00|fs); // choose clock
//     fs = ~fs ; // OFS is the one's complement of FS
//     HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL,(fs<<4)|SWL);
//     Switch_HDMITX_Bank_6613(0);
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CAT,AudioCatCode);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_SRCNUM,SoruceNum);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD0CHST_CHTNUM,0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CA_FS,0x00|fs); // choose clock
    fs = ~fs ; // OFS is the one's complement of FS
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL,(fs<<4)|SWL);
    Switch_HDMITX_Bank_6613(0);
    ...
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0,AudioEnable);
    }

    Instance[0].bAudioChannelEnable = AudioEnable ;

    // HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,B_AUD_RST_HDMITX);    // enable Audio
    return ER_SUCCESS;
}
#endif
...
AutoAdjustAudio()
{
    ...
    {
        Switch_HDMITX_Bank_6613(0);
        HDMITX_WriteI2C_Byte_6613(0xF8, 0xC3) ;
        HDMITX_WriteI2C_Byte_6613(0xF8, 0xA5) ;
        HDMITX_AndREG_Byte_6613(REG_TX_PKT_SINGLE_CTRL,~B_SW_CTS) ; // D[1] = 0, HW auto count CTS
        HDMITX_WriteI2C_Byte_6613(0xF8, 0xFF) ;
    }
    //delay1ms(50);
    Switch_HDMITX_Bank_6613(1);
    N = ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudN2)&0xF) << 16 ;
    N |= ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudN1)) <<8 ;
    N |= ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudN0));

    while(LoopCnt--)
    {   ULONG TempCTS=0;
        aCTS = ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudCTSCnt2)) << 12 ;
        aCTS |= ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudCTSCnt1)) <<4 ;
        aCTS |= ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudCTSCnt0)&0xf0)>>4  ;
        if(aCTS==TempCTS)
        {break;}
        TempCTS=aCTS;
    }
    ...
    uc = HDMITX_ReadI2C_Byte_6613(0xc1);
...
SetupAudioChannel()
{
    ...
    BYTE uc ;
    if( (HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST) & (B_AUD_RST_HDMITX|B_AREF_RST)) == 0) // audio enabled
    {
        Switch_HDMITX_Bank_6613(0);
        uc =HDMITX_ReadI2C_Byte_6613(REG_TX_AUDIO_CTRL0);
        if((uc & 0x1f) == 0x10)
        {
            if(HDMITX_ReadI2C_Byte_6613(REG_TX_CLK_STATUS2) & B_OSF_LOCK)
            {
                SetNCTS(Instance[0].TMDSClock, Instance[0].bAudFs); // to enable automatic progress setting for N/CTS
                delay1ms(5);
                AutoAdjustAudio();
                Switch_HDMITX_Bank_6613(0);
                HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, Instance[0].bAudioChannelEnable);
        ...
        {
            /*
            if((HDMITX_ReadI2C_Byte_6613(REG_TX_CLK_STATUS2) & B_OSF_LOCK)==0)
            {
                // AutoAdjustAudio();
                ...
                {
                    Switch_HDMITX_Bank_6613(0);
                    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, Instance[0].bAudioChannelEnable&0xF0);
                }
...
SetNCTS(ULONG PCLK,BYTE Fs)
{
    ...
    BOOL HBR_mode;
    BYTE aVIC;
    if(B_HBR & HDMITX_ReadI2C_Byte_6613(REG_TX_AUD_HDAUDIO))
    {
        HBR_mode=TRUE;
    }
    else
    ...
    Switch_HDMITX_Bank_6613(1);
    aVIC = (HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB4)&0x7f);
    Switch_HDMITX_Bank_6613(0);
    ...
    if(bForceCTS)
    {
        ...
        {
            delay1ms(30);
            CTS = ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudCTSCnt2)) << 12 ;
            CTS |= ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudCTSCnt1)) <<4 ;
            CTS |= ((unsigned long)HDMITX_ReadI2C_Byte_6613(REGPktAudCTSCnt0)&0xf0)>>4  ;
            if( CTS == 0)
            {
                continue;
            }
    ...
    HDMITX_WriteI2C_Byte_6613(REGPktAudCTS0,(BYTE)((LastCTS)&0xFF)) ;
    HDMITX_WriteI2C_Byte_6613(REGPktAudCTS1,(BYTE)((LastCTS>>8)&0xFF)) ;
    HDMITX_WriteI2C_Byte_6613(REGPktAudCTS2,(BYTE)((LastCTS>>16)&0xF)) ;
    Switch_HDMITX_Bank_6613(0) ;
#ifdef Force_CTS
    bForceCTS = TRUE;
#endif
    ...
    if(bForceCTS)
    {
        HDMITX_OrREG_Byte_6613(REG_TX_PKT_SINGLE_CTRL,B_SW_CTS) ; // D[1] = 0, HW auto count CTS
    }
    else
    {
        HDMITX_AndREG_Byte_6613(REG_TX_PKT_SINGLE_CTRL,~B_SW_CTS) ; // D[1] = 0, HW auto count CTS
    ...
    if(FALSE==HBR_mode) //LPCM
    {
        BYTE uData;
        Switch_HDMITX_Bank_6613(1);
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CA_FS,0x00|Fs);
        Fs = ~Fs ; // OFS is the one's complement of FS
        uData = (0x0f&HDMITX_ReadI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL));
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL,(Fs<<4)|uData);
        Switch_HDMITX_Bank_6613(0);
    }
...
ClearDDCFIFO()
{
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_FIFO_CLR);
}
...
{
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_GEN_SCLCLK);
}
//////////////////////////////////////////////////////////////////////
// Function: AbortDDC
// Parameter: N/A
...
AbortDDC()
{
    ...
    HDMITX_OrReg_Byte_6613(REG_TX_INT_CTRL,(1<<1));
    SWReset = HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST);
    CPDesire = HDMITX_ReadI2C_Byte_6613(REG_TX_HDCP_DESIRE);
    DDCMaster = HDMITX_ReadI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL);


    HDMITX_WriteI2C_Byte_6613(REG_TX_HDCP_DESIRE,CPDesire&(~B_CPDESIRE)); // @emily change order
    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,SWReset|B_HDCP_RST_HDMITX);         // @emily change order
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    ...
    for( i = 0 ; i < 2 ; i++ )
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_DDC_ABORT);

        for( timeout = 0 ; timeout < 200 ; timeout++ )
        {
            uc = HDMITX_ReadI2C_Byte_6613(REG_TX_DDC_STATUS);
            if (uc&B_DDC_DONE)
            {
                break ; // success
            }
...
//                HDMITX_DEBUG_PRINTF(("AbortDDC Fail by reg16=%02X\n",(int)uc));
    ...
    //HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,SWReset);
    //HDMITX_WriteI2C_Byte_6613(REG_TX_HDCP_DESIRE,CPDesire);
    //HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,DDCMaster);
    //~Jau-Chih.Tseng@ite.com.tw
    HDMITX_AndReg_Byte_6613(REG_TX_INT_CTRL,~(1<<1));
}
...
// {
//     Switch_HDMITX_Bank_6613(0);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_GCP,B_SET_AVMUTE);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_GENERAL_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
// }
...
// {
//     Switch_HDMITX_Bank_6613(0);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_GCP,B_CLR_AVMUTE);
//     HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_GENERAL_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
// }
...
SYS_STATUS
ReadEDID_6613(BYTE *pData,BYTE bSegment,BYTE offset,SHORT Count)
{
    ...
    // HDMITX_DEBUG_PRINTF(("ReadEDID_6613(%08lX,%d,%d,%d)\n",(ULONG)pData,(int)bSegment,(int)offset,(int)Count));
    if(!pData)
    {
//        HDMITX_DEBUG_PRINTF(("ReadEDID_6613(): Invallid pData pointer %08lX\n",(ULONG)pData));
        return ER_FAIL ;
    }

    if(HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT1) & B_INT_DDC_BUS_HANG)
    {
    ...
    while(RemainedCount > 0)
    {
        ...
        // HDMITX_DEBUG_PRINTF(("ReadEDID_6613(): ReqCount = %d,bCurrOffset = %d\n",(int)ReqCount,(int)bCurrOffset));
        ...
        for(TimeOut = 0 ; TimeOut < 200 ; TimeOut++)
        {
            ucdata = HDMITX_ReadI2C_Byte_6613(REG_TX_DDC_STATUS);
            ...
            if((ucdata & B_DDC_ERROR)||(HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT1) & B_INT_DDC_BUS_HANG))
            {
                HDMITX_DEBUG_PRINTF(("Called AboutDDC()\n"));
                AbortDDC();
                return ER_FAIL ;
        ...
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_HEADER,DDC_EDID_ADDRESS); // for EDID ucdata get
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQOFF,bCurrOffset);
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQCOUNT,(BYTE)ReqCount);
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_EDIDSEG,bSegment);
        HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_EDID_READ);
        ...
        for(TimeOut = 250 ; TimeOut > 0 ; TimeOut --)
        {
            ...
            {
                HDMITX_DEBUG_PRINTF(("ReadEDID_6613(): DDC_STATUS = %02X,fail.\n",(int)ucdata));
                HDMITX_AndReg_Byte_6613(REG_TX_INT_CTRL,~(1<<1));
                return ER_FAIL ;
            }
        }
        ...
        if(TimeOut == 0)
        {
            HDMITX_DEBUG_PRINTF(("ReadEDID_6613(): DDC TimeOut. \n",(int)ucdata));
            HDMITX_AndReg_Byte_6613(REG_TX_INT_CTRL,~(1<<1));
            return ER_FAIL ;
        }
        ...
        do
        {
            *(pBuff++) = HDMITX_ReadI2C_Byte_6613(REG_TX_DDC_READFIFO);
            ReqCount -- ;
        }while(ReqCount > 0);
...
{
    BYTE uc ;
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_MASK2) & (~(B_KSVLISTCHK_MASK|B_T_AUTH_DONE_MASK|B_AUTH_FAIL_MASK));
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR0,B_CLR_AUTH_FAIL|B_CLR_AUTH_DONE|B_CLR_KSVLISTCHK);
    HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR1,0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,B_INTACTDONE);
}
...
HDCP_ResetAuth()
{
    HDMITX_WriteI2C_Byte_6613(REG_TX_LISTCTRL,0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_HDCP_DESIRE,0);
    HDMITX_OrREG_Byte_6613(REG_TX_SW_RST,B_HDCP_RST_HDMITX);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    HDCP_ClearAuthInterrupt();
    AbortDDC();
}
...
{
    Switch_HDMITX_Bank_6613(0);
    return HDMITX_WriteI2C_Byte_6613(REG_TX_ENCRYPTION,B_ENABLE_ENCRYPTION);
}
...
HDCP_Auth_Fire()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHDCP); // MASTERHDCP,no need command but fire.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUTHFIRE,1);
}
...
HDCP_StartAnCipher()
{
    HDMITX_WriteI2C_Byte_6613(REG_TX_AN_GENERATE,B_START_CIPHER_GEN);
...
HDCP_StopAnCipher()
{
    HDMITX_WriteI2C_Byte_6613(REG_TX_AN_GENERATE,B_STOP_CIPHER_GEN);
}
...
HDCP_GenerateAn()
{
    ...
    HDMITX_ReadI2C_ByteN_6613(REG_TX_AN_GEN,Data,8);
#else
    Data[0] = 0 ;Data[1] = 0 ;Data[2] = 0 ;Data[3] = 0 ;
    Data[4] = 0 ;Data[5] = 0 ;Data[6] = 0 ;Data[7] = 0 ;
#endif
    HDMITX_WriteI2C_ByteN_6613(REG_TX_AN,Data,8);
...
HDCP_GetBCaps(PBYTE pBCaps ,unsigned int *pBStatus)
{
    ...
    Switch_HDMITX_Bank_6613(0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_HEADER,DDC_HDCP_ADDRESS);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQOFF,0x40); // BCaps offset
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQCOUNT,3);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_DDC_SEQ_BURSTREAD);
...
//            HDMITX_DEBUG_PRINTF(("HDCP_GetBCaps(): DDC fail by reg16=%02X.\n",ucdata));
    ...
    ucdata = HDMITX_ReadI2C_Byte_6613(REG_TX_BSTAT+1);
    *pBStatus = (unsigned int)ucdata ;
    *pBStatus <<= 8 ;
    ucdata = HDMITX_ReadI2C_Byte_6613(REG_TX_BSTAT);
    *pBStatus |= ((unsigned int)ucdata&0xFF) ;
    *pBCaps = HDMITX_ReadI2C_Byte_6613(REG_TX_BCAP);
    return ER_SUCCESS ;
...
HDCP_GetBKSV(BYTE *pBKSV)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_HEADER,DDC_HDCP_ADDRESS);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQOFF,0x00); // BKSV offset
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQCOUNT,5);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_DDC_SEQ_BURSTREAD);
    ...
    HDMITX_ReadI2C_ByteN_6613(REG_TX_BKSV,(PBYTE)pBKSV,5);
...
{
    BYTE uc ;
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST) | B_HDCP_RST_HDMITX ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST,uc);
    HDMITX_WriteI2C_Byte_6613(REG_TX_HDCP_DESIRE,0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_LISTCTRL,0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERHOST);
    ClearDDCFIFO();
    AbortDDC();
}
...
HDCP_Authenticate()
{
    ...
    for( TimeOut = 0 ; TimeOut < 20 ; TimeOut++ )
    {
        ...
        if(B_TX_HDMI_MODE == (HDMITX_ReadI2C_Byte_6613(REG_TX_HDMI_MODE) & B_TX_HDMI_MODE ))
        {
...
//    HDMITX_DEBUG_PRINTF(("BKSV %02X %02X %02X %02X %02X\n",(int)BKSV[0],(int)BKSV[1],(int)BKSV[2],(int)BKSV[3],(int)BKSV[4]));
    ...
    Switch_HDMITX_Bank_6613(0); // switch bank action should start on direct register writting of each function.

    // 2006/08/11 added by jjtseng
    // enable HDCP on CPDired enabled.
    HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,~(B_HDCP_RST_HDMITX));
    //~jjtseng 2006/08/11

    HDMITX_WriteI2C_Byte_6613(REG_TX_HDCP_DESIRE,B_CPDESIRE);
    HDCP_ClearAuthInterrupt();
    ...
    if((BCaps & B_CAP_HDMI_REPEATER) == 0)
    {
        ...
        for(TimeOut = 250 ; TimeOut > 0 ; TimeOut --)
        {
            ...
            ucdata = HDMITX_ReadI2C_Byte_6613(REG_TX_AUTH_STAT);
            // HDMITX_DEBUG_PRINTF(("reg46 = %02x reg16 = %02x\n",(int)ucdata,(int)HDMITX_ReadI2C_Byte_6613(0x16)));
            ...
            ucdata = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT2);
            if(ucdata & B_INT_AUTH_FAIL)
            {
                /*
                HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR0,B_CLR_AUTH_FAIL);
                HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR1,0);
                HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,B_INTACTDONE);
                HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,0);
                */
...
HDCP_VerifyIntegration()
{
    ...
    if(HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT1) & B_INT_AUTH_FAIL)
    {
        HDCP_ClearAuthInterrupt();
        Instance[0].bAuthenticated = FALSE ;
        return ER_FAIL ;
...
HDCP_CancelRepeaterAuthenticate()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERDDC|B_MASTERHOST);
    AbortDDC();
    HDMITX_WriteI2C_Byte_6613(REG_TX_LISTCTRL,B_LISTFAIL|B_LISTDONE);
    HDCP_ClearAuthInterrupt();
}
...
{
    HDMITX_WriteI2C_Byte_6613(REG_TX_LISTCTRL,B_LISTDONE);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERHDCP);
}
...
HDCP_GetKSVList(BYTE *pKSVList,BYTE cDownStream)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERHOST);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_HEADER,0x74);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQOFF,0x43);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQCOUNT,cDownStream * 5);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_DDC_SEQ_BURSTREAD);
    ...
    {
        pKSVList[TimeOut] = HDMITX_ReadI2C_Byte_6613(REG_TX_DDC_READFIFO);
...
HDCP_GetVr(BYTE *pVr)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_MASTER_CTRL,B_MASTERHOST);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_HEADER,0x74);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQOFF,0x20);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_REQCOUNT,20);
    HDMITX_WriteI2C_Byte_6613(REG_TX_DDC_CMD,CMD_DDC_SEQ_BURSTREAD);
    ...
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_SHA_SEL ,TimeOut);
        pVr[TimeOut*4]  = (ULONG)HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE1);
        pVr[TimeOut*4+1] = (ULONG)HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE2);
        pVr[TimeOut*4+2] = (ULONG)HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE3);
        pVr[TimeOut*4+3] = (ULONG)HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE4);
...
HDCP_GetM0(BYTE *pM0)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_SHA_SEL,5); // read m0[31:0] from reg51~reg54
    pM0[0] = HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE1);
    pM0[1] = HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE2);
    pM0[2] = HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE3);
    pM0[3] = HDMITX_ReadI2C_Byte_6613(REG_TX_SHA_RD_BYTE4);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SHA_SEL,0); // read m0[39:32] from reg55
    pM0[4] = HDMITX_ReadI2C_Byte_6613(REG_TX_AKSV_RD_BYTE5);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SHA_SEL,1); // read m0[47:40] from reg55
    pM0[5] = HDMITX_ReadI2C_Byte_6613(REG_TX_AKSV_RD_BYTE5);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SHA_SEL,2); // read m0[55:48] from reg55
    pM0[6] = HDMITX_ReadI2C_Byte_6613(REG_TX_AKSV_RD_BYTE5);
    HDMITX_WriteI2C_Byte_6613(REG_TX_SHA_SEL,3); // read m0[63:56] from reg55
    pM0[7] = HDMITX_ReadI2C_Byte_6613(REG_TX_AKSV_RD_BYTE5);
...
HDCP_Authenticate_Repeater()
{
    ...
    // HDMITX_WriteI2C_Byte_6613(0x20,0x00);
    // HDMITX_WriteI2C_Byte_6613(0x04,0x01);
    // HDMITX_WriteI2C_Byte_6613(0x10,0x01);
    // HDMITX_WriteI2C_Byte_6613(0x15,0x0F);
    // delay1ms(100);
    // HDMITX_WriteI2C_Byte_6613(0x04,0x00);
    // HDMITX_WriteI2C_Byte_6613(0x10,0x00);
    // HDMITX_WriteI2C_Byte_6613(0x20,0x01);
    // delay1ms(100);
    // test07 = HDMITX_ReadI2C_Byte_6613(0x7);
    // test06 = HDMITX_ReadI2C_Byte_6613(0x6);
    // test08 = HDMITX_ReadI2C_Byte_6613(0x8);
    ...
    for(TimeOut = 250*6 ; TimeOut > 0 ; TimeOut --)
    {
        ...
        uc = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT1);
        ...
        uc = HDMITX_ReadI2C_Byte_6613(REG_TX_INT_STAT2);
        ...
        // emily add for test
        // test =(HDMITX_ReadI2C_Byte_6613(0x7)&0x4)>>2 ;
        if(uc & B_INT_KSVLIST_CHK)
        {
            HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR0,B_CLR_KSVLISTCHK);
            HDMITX_WriteI2C_Byte_6613(REG_TX_INT_CLR1,0);
            HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,B_INTACTDONE);
            HDMITX_WriteI2C_Byte_6613(REG_TX_SYS_STATUS,0);
...
ENABLE_NULL_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_NULL_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_ACP_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_ACP_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_ISRC1_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_ISRC1_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_ISRC2_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_ISRC2_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_AVI_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVI_INFOFRM_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_AUD_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_INFOFRM_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_SPD_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_SPD_INFOFRM_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
ENABLE_MPG_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_MPG_INFOFRM_CTRL,B_ENABLE_PKT|B_REPEAT_PKT);
}
...
DISABLE_NULL_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_NULL_CTRL,0);
}
...
DISABLE_ACP_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_ACP_CTRL,0);
}
...
DISABLE_ISRC1_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_ISRC1_CTRL,0);
}
...
DISABLE_ISRC2_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_ISRC2_CTRL,0);
}
...
DISABLE_AVI_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVI_INFOFRM_CTRL,0);
}
...
DISABLE_AUD_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_INFOFRM_CTRL,0);
}
...
DISABLE_SPD_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_SPD_INFOFRM_CTRL,0);
}
...
DISABLE_MPG_INFOFRM_PKT()
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_MPG_INFOFRM_CTRL,0);
}
...
SetAVIInfoFrame(AVI_InfoFrame *pAVIInfoFrame)
{
    ...
    Switch_HDMITX_Bank_6613(1);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB1,pAVIInfoFrame->pktbyte.AVI_DB[0]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB2,pAVIInfoFrame->pktbyte.AVI_DB[1]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB3,pAVIInfoFrame->pktbyte.AVI_DB[2]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB4,pAVIInfoFrame->pktbyte.AVI_DB[3]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB5,pAVIInfoFrame->pktbyte.AVI_DB[4]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB6,pAVIInfoFrame->pktbyte.AVI_DB[5]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB7,pAVIInfoFrame->pktbyte.AVI_DB[6]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB8,pAVIInfoFrame->pktbyte.AVI_DB[7]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB9,pAVIInfoFrame->pktbyte.AVI_DB[8]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB10,pAVIInfoFrame->pktbyte.AVI_DB[9]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB11,pAVIInfoFrame->pktbyte.AVI_DB[10]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB12,pAVIInfoFrame->pktbyte.AVI_DB[11]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_DB13,pAVIInfoFrame->pktbyte.AVI_DB[12]);
    ...
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB1)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB2)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB3)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB4)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB5)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB6)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB7)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB8)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB9)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB10)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB11)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB12)));
    HDMITX_DEBUG_PRINTF(("%02X ",(int)HDMITX_ReadI2C_Byte_6613(REG_TX_AVIINFO_DB13)));
    HDMITX_DEBUG_PRINTF(("\n"));
    */
    ucData -= 0x80+AVI_INFOFRAME_VER+AVI_INFOFRAME_TYPE+AVI_INFOFRAME_LEN ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_AVIINFO_SUM,ucData);
...
SetAudioInfoFrame(Audio_InfoFrame *pAudioInfoFrame)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_AUDINFO_CC,pAudioInfoFrame->pktbyte.AUD_DB[0]);
    uc -= HDMITX_ReadI2C_Byte_6613(REG_TX_PKT_AUDINFO_CC); uc &= 0xFF ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_AUDINFO_SF,pAudioInfoFrame->pktbyte.AUD_DB[1]);
    uc -= HDMITX_ReadI2C_Byte_6613(REG_TX_PKT_AUDINFO_SF); uc &= 0xFF ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_AUDINFO_CA,pAudioInfoFrame->pktbyte.AUD_DB[3]);
    uc -= HDMITX_ReadI2C_Byte_6613(REG_TX_PKT_AUDINFO_CA); uc &= 0xFF ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_AUDINFO_DM_LSV,pAudioInfoFrame->pktbyte.AUD_DB[4]);
    uc -= HDMITX_ReadI2C_Byte_6613(REG_TX_PKT_AUDINFO_DM_LSV); uc &= 0xFF ;

    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_AUDINFO_SUM,uc);
...
SetSPDInfoFrame(SPD_InfoFrame *pSPDInfoFrame)
{
    ...
    for(i = 0,ucData = 0 ; i < 25 ; i++)
    {
        ...
        HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_SPDINFO_PB1+i,pSPDInfoFrame->pktbyte.SPD_DB[i]);
    }
    ucData -= 0x80+SPD_INFOFRAME_VER+SPD_INFOFRAME_TYPE+SPD_INFOFRAME_LEN ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_SPDINFO_SUM,ucData); // checksum
    Switch_HDMITX_Bank_6613(0);
    ENABLE_SPD_INFOFRM_PKT();
    return ER_SUCCESS ;
}
...
SetMPEGInfoFrame(MPEG_InfoFrame *pMPGInfoFrame)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKT_MPGINFO_FMT,pMPGInfoFrame->info.FieldRepeat|(pMPGInfoFrame->info.MpegFrame<<1));
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKG_MPGINFO_DB0,pMPGInfoFrame->pktbyte.MPG_DB[0]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKG_MPGINFO_DB1,pMPGInfoFrame->pktbyte.MPG_DB[1]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKG_MPGINFO_DB2,pMPGInfoFrame->pktbyte.MPG_DB[2]);
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKG_MPGINFO_DB3,pMPGInfoFrame->pktbyte.MPG_DB[3]);
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_PKG_MPGINFO_SUM,ucData);
...
void
setHDMITX_ChStat_6613(BYTE ucIEC60958ChStat[])
{
    BYTE uc ;

    Switch_HDMITX_Bank_6613(1);
    uc = (ucIEC60958ChStat[0] <<1)& 0x7C ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_MODE,uc);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CAT,ucIEC60958ChStat[1]); // 192, audio CATEGORY
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_SRCNUM,ucIEC60958ChStat[2]&0xF);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD0CHST_CHTNUM,(ucIEC60958ChStat[2]>>4)&0xF);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CA_FS,ucIEC60958ChStat[3]); // choose clock
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL,ucIEC60958ChStat[4]);
    Switch_HDMITX_Bank_6613(0);
}

void
setHDMITX_UpdateChStatFs_6613(ULONG Fs)
{
    BYTE uc ;
    ...
    Switch_HDMITX_Bank_6613(1);
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_AUDCHST_CA_FS); // choose clock
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_CA_FS,uc); // choose clock
    uc &= 0xF0 ;
    uc |= (Fs&0xF);

    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL);
    uc &= 0xF ;
    uc |= ((~Fs) << 4)&0xF0 ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDCHST_OFS_WL,uc);
...
void
setHDMITX_LPCMAudio_6613(BYTE AudioSrcNum, BYTE AudSWL, BOOL bSPDIF)
{
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL1,AudioFormat); // regE1 bOutputAudioMode should be loaded from ROM image.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_FIFOMAP,0xE4); // default mapping.
#ifdef USE_SPDIF_CHSTAT
    if( bSPDIF )
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL3,B_CHSTSEL);
    }
    else
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL3,0);
    }
#else // not USE_SPDIF_CHSTAT
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL3,0);
#endif // USE_SPDIF_CHSTAT

    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_SRCVALID_FLAT,0x00);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_HDAUDIO,0x00); // regE5 = 0 ;

    if( bSPDIF )
    {
        BYTE i ;
        HDMI_OrREG_TX_Byte_6613(0x5c,(1<<6));
        for( i = 0 ; i < 100 ; i++ )
        {
            if(HDMITX_ReadI2C_Byte_6613(REG_TX_CLK_STATUS2) & B_OSF_LOCK)
            {
...
void
setHDMITX_NLPCMAudio_6613() // no Source Num, no I2S.
{
    BYTE AudioEnable, AudioFormat ;
    BYTE i ;
    ...
    Switch_HDMITX_Bank_6613(0);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, M_AUD_24BIT|B_AUD_SPDIF);
    //HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,~(B_AUD_RST_HDMITX|B_AREF_RST));

    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL1,0x01); // regE1 bOutputAudioMode should be loaded from ROM image.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_FIFOMAP,0xE4); // default mapping.
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, M_AUD_24BIT|B_AUD_SPDIF|B_AUD_EN_I2S0);
}

void
setHDMITX_HBRAudio_6613(BOOL bSPDIF)
{
    BYTE rst,uc ;
    Switch_HDMITX_Bank_6613(0);

    rst = HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST);

    //HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST, rst | (B_AUD_RST_HDMITX|B_AREF_RST) );

    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL1,0x47); // regE1 bOutputAudioMode should be loaded from ROM image.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_FIFOMAP,0xE4); // default mapping.
    ...
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, M_AUD_24BIT);
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL3,0);
    }

    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_SRCVALID_FLAT,0x08);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_HDAUDIO,B_HBR); // regE5 = 0 ;
    uc = HDMITX_ReadI2C_Byte_6613(REG_TX_CLK_CTRL1);
    uc &= ~M_AUD_DIV ;
    HDMITX_WriteI2C_Byte_6613(REG_TX_CLK_CTRL1, uc);
    ...
    if( bSPDIF )
    {
        ...
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, M_AUD_24BIT|B_AUD_SPDIF|B_AUD_EN_SPDIF);
    }
    else
    {
        HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL0, M_AUD_24BIT|B_AUD_EN_I2S3|B_AUD_EN_I2S2|B_AUD_EN_I2S1|B_AUD_EN_I2S0);
    }
    HDMI_AndREG_TX_Byte_6613(0x5c,~(1<<6));
    Instance[0].bAudioChannelEnable=HDMITX_ReadI2C_Byte_6613(REG_TX_AUDIO_CTRL0);
    //HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST, rst & ~(B_AUD_RST_HDMITX|B_AREF_RST) );
}

void
setHDMITX_DSDAudio_6613()
{
    // to be continue
    BYTE rst, uc ;
    rst = HDMITX_ReadI2C_Byte_6613(REG_TX_SW_RST);
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_CTRL1,0x41); // regE1 bOutputAudioMode should be loaded from ROM image.
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUDIO_FIFOMAP,0xE4); // default mapping.
    ...
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_SRCVALID_FLAT,0x00);
    HDMITX_WriteI2C_Byte_6613(REG_TX_AUD_HDAUDIO,B_DSD); // regE5 = 0 ;
    //HDMITX_WriteI2C_Byte_6613(REG_TX_SW_RST, rst & ~(B_AUD_RST_HDMITX|B_AREF_RST) );
...
void
EnableHDMIAudio_6613(BYTE AudioType, BOOL bSPDIF,  ULONG SampleFreq,  BYTE ChNum, BYTE *pIEC60958ChStat, ULONG TMDSClock)
{
    ...
    HDMITX_OrReg_Byte_6613(REG_TX_SW_RST,(B_AUD_RST_HDMITX | B_AREF_RST));
    HDMITX_WriteI2C_Byte_6613(REG_TX_CLK_CTRL0,B_AUTO_OVER_SAMPLING_CLOCK|B_EXT_256FS|0x01);
    if(bSPDIF)
    {
        if(AudioType==T_AUDIO_HBR)
        {
            HDMITX_WriteI2C_Byte_6613(REG_TX_CLK_CTRL0,0x81);
        }
        HDMITX_OrREG_Byte_6613(REG_TX_AUDIO_CTRL0,B_AUD_SPDIF);
    }
    else
    {
        HDMITX_AndREG_Byte_6613(REG_TX_AUDIO_CTRL0,(~B_AUD_SPDIF));
    }
    ...
    case T_AUDIO_HBR:
        ...
        setHDMITX_ChStat_6613(pIEC60958ChStat);
        setHDMITX_HBRAudio_6613(bSPDIF);
    ...
    case T_AUDIO_LPCM:
        ...
        setHDMITX_ChStat_6613(pIEC60958ChStat);
        setHDMITX_LPCMAudio_6613((ChNum+1)/2, /*24*/SUPPORT_AUDI_AudSWL, bSPDIF);
        // can add auto adjust
        break ;
    }
    HDMITX_AndREG_Byte_6613(REG_TX_INT_MASK1,(~B_AUDIO_OVFLW_MASK));
    HDMITX_AndREG_Byte_6613(REG_TX_SW_RST,~(B_AUD_RST_HDMITX|B_AREF_RST));
}
...
static SYS_STATUS Set_GeneralPurpose_PKT(BYTE *pData)
{
    ...
    for( i = 0x38 ; i <= 0x56 ; i++)
    {
        HDMITX_WriteI2C_Byte_6613(i, pData[i-0x38] ) ;
    }
    Switch_HDMITX_Bank_6613(0);
    ENABLE_GeneralPurpose_PKT();
    //ENABLE_NULL_PKT() ;
...
BOOL
EnableVendorSpecificInfoFrame_6613(BYTE bEnable, BYTE *pInfoFrame)
{
    BYTE checksum ;
    int i ;
    if( !bEnable)
...
//////////////////////////////////////////////////////////////////////
// Function: DumpCatHDMITXReg_6613()
// Parameter: N/A
// Return: N/A
...
DumpCatHDMITXReg_6613()
{
    ...
    for(i = 0 ; i < 0x100 ; i+=16)
    {
        ...
        for(j = 0 ; j < 16 ; j++)
        {
            ucData = HDMITX_ReadI2C_Byte_6613((BYTE)((i+j)&0xFF));
