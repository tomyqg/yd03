...
//=============================================================================
    ...
    #endif
    #define isp_EnginClockOn(ispcore)           ithIspEnableClock(ispcore)
    #define isp_EnginClockOff(ispcore)          ithIspDisableClock(ispcore)
    //#define isp_EnginReset(ispcore)             {ithIspResetEngine(ispcore); ithIspResetReg(ispcore);}
