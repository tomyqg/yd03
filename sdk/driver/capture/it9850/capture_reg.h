...
#define CAP_SHT_TOPFIELDSKIPEN          15
#define CAP_SHT_TOPFIELDSKIP            14
#define CAP_SHT_TOPFIELDPOL             13
#define CAP_SHT_INTERLEAVEMODE          12
#define CAP_SHT_4X2XMODE                10
...
#define CAP_SHT_420MODE                 3
#define CAP_SHT_NV12MODE                2
#define CAP_SHT_CCIRMODE                1

#define CAP_MSK_4X2XMODE                (N02_BITS_MSK << CAP_SHT_4X2XMODE)              // 0000 1100 0000 0000
...
/*
 * 0x203C
 *    Video Signal Setting Register
 */
//====================================================================
#define CAP_REG_LCDSRC_CAP              (REG_CAP_BASE + 0x003C)

#define CAP_SHT_DEPOL                   5
#define CAP_SHT_HSYNCDE                 4
#define CAP_SHT_LCDSRC                  0
#define CAP_MSK_DEPOL                   (N01_BITS_MSK << CAP_SHT_DEPOL)         // 0000 0000 0010 0000
#define CAP_MSK_HSYNCDE                 (N01_BITS_MSK << CAP_SHT_HSYNCDE)       // 0000 0000 0001 0000
#define CAP_MSK_LCDSRC                  (N01_BITS_MSK << CAP_SHT_LCDSRC)        // 0000 0000 0000 0001
...
#define CAP_REG_HSYNC_COUNT_L           (REG_CAP_BASE + 0x004E)
#define CAP_REG_HSYNC_COUNT_H           (REG_CAP_BASE + 0x0050)
...
#define CAP_REG_DROP_FRAME_L    (REG_CAP_BASE + 0x0052)
#define CAP_REG_DROP_FRAME_H    (REG_CAP_BASE + 0x0054)

#define CAP_REG_DROP_ENABLE     (REG_CAP_BASE + 0x0056)
#define CAP_BIT_DROP_ENABLE     5
#define CAP_SHT_DROP_LENGTH     0
#define CAP_MSK_DROP_LENGTH     (N05_BITS_MSK << CAP_SHT_DROP_LENGTH)           // 0000 0000 0001 1111
