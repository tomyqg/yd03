...
#define AE_WND_1_2
//#define AE_WND_FULL
#define CAPTURE_WIDTH CFG_CAPTURE_WIDTH
...
static bool                 gHM1375InitDone             = MMP_FALSE;
static uint16_t             HM1375_INDEX = 0;
...
static uint16_t _HM1375_ReadI2c_Byte(uint16_t RegAddr)
{
    ...
    *pdbuf++    = (uint8_t)(RegAddr & 0x00ff);
    ...
    if (0 != (flag = mmpIicReceiveData(IIC_PORT_0, IIC_MASTER_MODE, HM1375_IICADDR, dbuf, 2, pdbuf, 1)))
    {
...
static uint32_t _HM1375_WriteI2c_Byte(uint16_t RegAddr, uint8_t data)
{
    uint32_t    flag;
    uint8_t     dbuf[256];
    uint8_t     *pdbuf = dbuf;
...
static bool _HM1375_ReadSensorID(void)
{
    uint32_t SenSorID;
...
void HM1375Initialize(uint16_t Mode)
{
	...
	if(CAPTURE_WIDTH == 1280)
	{
    	printf("setting resulution 1280x720!\n");
    	_HM1375Set1280x720P30();
	}else if (CAPTURE_WIDTH == 800)
	{
...
uint16_t HM1375GetProperty(MODULE_GETPROPERTY property)
{
	switch(property)
	{
     case GetTopFieldPolarity:
	    ...
	    break;
	 case GetHeight:
	 	return HM1375_InHeight;
	    break;
	 case GetWidth:
	 	return HM1375_InWidth;
        break;
	 case Rate:
	 	return HM1375_InFrameRate;
        break;
	 case GetModuleIsInterlace:
	 	return 0;
	    break;
	 case FrameRate:
	 	return HM1375_TABLE[HM1375_INDEX].FrameRate;
	    break;
     case matchResolution:
	 	return MMP_TRUE;
	    break;
	 case HPolarity:
	 	return HM1375_TABLE[HM1375_INDEX].HPolarity;
	 	break;
	 case VPolarity:
	 	return HM1375_TABLE[HM1375_INDEX].VPolarity;
	 	break;
	 case HStar:
	 	return HM1375_TABLE[HM1375_INDEX].HStar;
	 	break;
	 case HEnd:
	 	return HM1375_TABLE[HM1375_INDEX].HEnd;
	 	break;
	 case VStar1:
	 	return HM1375_TABLE[HM1375_INDEX].VStar1;
	 	break;
	 case VEnd1:
	 	return HM1375_TABLE[HM1375_INDEX].VEnd1;
	 	break;
	 case VStar2:
	 	return HM1375_TABLE[HM1375_INDEX].VStar2;
	 	break;
	 case VEnd2:
	 	return HM1375_TABLE[HM1375_INDEX].VEnd2;
	 	break;
	 default:
        return 0;
		break;
...
void HM1375SetProperty(MODULE_SETPROPERTY Property, uint16_t Value)
{
}
