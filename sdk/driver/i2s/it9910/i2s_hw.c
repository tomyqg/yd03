...
uint16_t    _regRxBufAddr[I2S_RX_BUF_COUNT] =
{
    ...
    I2S_REG_RX_BUF_2_ADDR,
    I2S_REG_RX_BUF_3_ADDR,
    I2S_REG_RX_BUF_4_ADDR,
    I2S_REG_RX_BUF_5_ADDR
};
    ...
    I2S_TX_BUF_ID txBufId)
{
    ...
    return _REG_Read32(_regTxBufAddr[txBufId]);
}
...
_I2S_GetRxBufAddr(
    I2S_RX_BUF_ID rxBufId)
{
    return _REG_Read32(_regRxBufAddr[rxBufId]);
}
