...
void ithStorageUnSelect(ITHStorage storage)
{
    ...
    ithWriteRegMaskA((ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG), 0x0, 0x7);
    ...
    case ITH_STOR_SD1:
        /** disable sd2 clk power */
        {
            ...
            ithGpioCtrlDisable(SD2_CLK_GPIO, ITH_GPIO_PULL_ENABLE); /** pull up/down disable */
        }
...
void ithStorageSelect(ITHStorage storage)
{
    ...
    if (storage == ITH_STOR_SD1)
        ithWriteRegMaskA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, ITH_STOR_SD << ITH_GPIO_STOR_SEL_POS, ITH_GPIO_STOR_SEL_MSK);
    else
        ithWriteRegMaskA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, storage << ITH_GPIO_STOR_SEL_POS, ITH_GPIO_STOR_SEL_MSK);
...
static uint16_t sd_gpio_tlb[55] = {
    ...
    #if 0                                                                       // fpga test 8-bits TODO
    SET_SDC(0) | SET_SD_PIN_IDX(4) | SET_SD_DATA_MODE(2),                       // gpio 13
    SET_SDC(0) | SET_SD_PIN_IDX(5) | SET_SD_DATA_MODE(2),                       // gpio 14
    SET_SDC(0) | SET_SD_PIN_IDX(6) | SET_SD_DATA_MODE(2),                       // gpio 15
    SET_SDC(0) | SET_SD_PIN_IDX(7) | SET_SD_DATA_MODE(2),                       // gpio 16
    #else
