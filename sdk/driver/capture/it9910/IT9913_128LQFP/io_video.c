    ...
    CAP_CONTEXT *Capctxt)
{
    ...
    {
        memcpy(&Capctxt->inmux_info.Y_Pin_Num, &R_V_16Pin, CAP_DATA_BUS_WIDTH);
        memcpy(&Capctxt->inmux_info.U_Pin_Num, &G_Y_16Pin, CAP_DATA_BUS_WIDTH);
        memcpy(&Capctxt->inmux_info.V_Pin_Num, &B_U_16Pin, CAP_DATA_BUS_WIDTH);
    }
    else //YPbPr Input
    {
        memcpy(&Capctxt->inmux_info.Y_Pin_Num, &G_Y_16Pin, CAP_DATA_BUS_WIDTH);
        memcpy(&Capctxt->inmux_info.U_Pin_Num, &B_U_16Pin, CAP_DATA_BUS_WIDTH);
        memcpy(&Capctxt->inmux_info.V_Pin_Num, &R_V_16Pin, CAP_DATA_BUS_WIDTH);
    }
}
    ...
    CAP_CONTEXT *Capctxt)
{
    ...
    Capctxt->iomode_info.EnInternalRxHDMI = 0x1; //1: VDI from internal HDMI Rx.
    ...
    CAP_CONTEXT *Capctxt)
{
    ...
    /* Input  pin mux setting */
    memcpy(&Capctxt->inmux_info.Y_Pin_Num, &R_Y_16Pin, CAP_DATA_BUS_WIDTH);
    memcpy(&Capctxt->inmux_info.U_Pin_Num, &G_U_16Pin, CAP_DATA_BUS_WIDTH);
    memcpy(&Capctxt->inmux_info.V_Pin_Num, &B_V_16Pin, CAP_DATA_BUS_WIDTH);
}
